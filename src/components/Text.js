const Text = {
  aboutMe:`👋 Hi, I’m Connor I'm currently seeking Opportunities in the Tech Industry.

🔧 I'm an full stack developer with proficiency in Python, JavaScript, web design, Linux, Git, and more. For the last five years, through my Masters and PhD programs, I have specialized in developing cutting-edge building energy management tools using mixed methods and human-centered approaches. Outside of academia, I engage in personal projects ranging from full-stack web development to cybersecurity competitions, which continuously sharpen my expertise. I'm actively pursuing opportunities to expand my technical skills and contribute innovative solutions.

💼 Im currently seeking roles where I can leverage my development experience and academic background to drive innovation and make meaningful contributions in the tech sector.`,
